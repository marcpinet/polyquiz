...
export class AuthService {
  ...
  login(user: User) {
    return new Promise(
      ((resolve, reject) => {
        this.http.post<User>(this.authUrl + '/' + this.loginPath, user, httpOptionsBase).subscribe((user) => {
          this.user = user;
  ...
  getLogin() {
    return new Promise(
      ((resolve, reject) => {
        this.http.get(this.authUrl + '/' + this.loginPath, httpOptionsBase).subscribe((user) => {
